...
class ConsensusAgent(BaseAgent[PipelineState]):
    ...
    def __init__(
        ...
        # NOTE: the non-voting IntentGate guard (Design G/G2) is now a SEPARATE
        # post-consensus stage — see src.agents.intent_gate_agent.IntentGateAgent.
        # ConsensusAgent is pure weighted voting; it no longer knows about the gate.
