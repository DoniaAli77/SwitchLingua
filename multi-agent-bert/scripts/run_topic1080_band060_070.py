"""Topic-1080 @272 (seed 42) + full agentic pipeline at tau=0.60, on its OWN
established test set: the unchanged Silver-1163 (1163 rows).

Checkpoint rebuilt and verified bit-identical to the recorded original
(acc 0.6311 / macroF1 0.5785, 1163/1163 predictions and confidences match).
tau=0.60 chosen label-blind from the confidence distribution (routes 266 =
22.9%); NOT pre-registered and NOT optimised on correctness.
...
OUT_DIR = ROOT / "experiments/outputs/multi_agent_bert/experiment_topic1080_agentic_tau070_band"
...
# ---------------------------------------------------------------- run it
ARGV = [
    "--dataset", "experiments/outputs/multi_agent_bert/experiment_topic1080_agentic_tau070_band/band_060_070.jsonl",
    ...
    "--transformer_checkpoint", "D:/switchlingua_checkpoints/topic1080_272_seed42",
    "--transformer_device", "cuda",
    "--llm_client", "openai",
    "--llm_model", "gpt-4o-mini",
    "--output_dir", str(OUT_DIR / "pipeline_out"),
    "--run_id", "topic1080_band060_070_seed42",
]
