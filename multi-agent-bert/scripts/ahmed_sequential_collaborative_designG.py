...
os.environ['SENTIMENT_AGENT_VARIANT'] = 'lexical_polarity_contextual_intent_gate'  # Design G (full gate)
...
o = io.StringIO()
def P(s=''): o.write(s + '\n')
P('SEQUENTIAL FRAMING TEST — Design G, Ahmed, %s, threshold %.2f' % (MODEL, THRESH))
