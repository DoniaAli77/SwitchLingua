...
os.environ['SENTIMENT_PROMPT_VARIANT'] = 'semantic_v3_pragmatic_contextual'
...
RUN = 'experiments/outputs/multi_agent_bert/experiment_ahmed_v3_pragmatic'
...
print('Design V3 — escalated:', len(esc), flush=True)
