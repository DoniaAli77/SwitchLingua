...
AUDIT_CALLS = OUT_DIR / "audit_llm_calls_retry.jsonl"       # one record per LLM call
AUDIT_ROWS = OUT_DIR / "audit_rows_retry.jsonl"             # one record per sample
...
# ---------------------------------------------------------------- run it
ARGV = [
    "--dataset", "experiments/outputs/multi_agent_bert/experiment_gen540_agentic_silver1163_tau040_exploratory/retry_row.jsonl",
    ...
    "--output_dir", str(OUT_DIR / "pipeline_out_retry"),
    "--run_id", "band_retry_00763",
]
